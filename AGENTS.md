...
- When that repair also updates source classification or check-SHA behavior, treat the README and governance docs as closeout evidence rather than optional follow-up notes.
