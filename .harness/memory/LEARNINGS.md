...
**2026-08-01 [Codex]:** The shared threshold for routine correction and systemic promotion is now canonical across the governed guidance, validator, and guard -> preserve historical learnings above; for new incidents, promote only for a contradictory contract, crossed safety boundary, recurrence across independent work, or named current consumer, otherwise record `no_system_change` with reason, checked scope, and no-durable-destination decision.
