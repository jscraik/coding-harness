...
| --- | --- | --- | ---: | --- |
| Plan BLUF structure | After plan creation/update | Portable BLUF validation not yet integrated; temporarily validate manually | yes | pass |
| Plan artifact shape | After plan creation/update | Portable shape validation not yet integrated; temporarily validate manually | yes | pass |
| Plan artifact identity | After plan creation/update | Portable identity validation not yet integrated; temporarily validate manually | yes | pass |
| Linear traceability | After plan creation/update | Portable traceability validation not yet integrated; temporarily validate manually | yes | pass |
