...
| [governance](./governance/) | Policy controls, approvals, and audit expectations. | 2026-05-08 | 4 rules |
...
- [governance] Captured JSC-288 governance trust proof rule: memory proof must be executable and current, and closeout evals must pass the canonical HE eval-report validator before closure (2026-05-08)
