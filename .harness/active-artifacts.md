...
Current working reconciliation: 2026-06-11 post-PR #404 pullback for JSC-363.
PR #404 merged the source-tracked post-PR #403 route-truth refresh into
`main` at `68c8019515641f4fe2ff8ada917d4f2b1a170b1e` from submitted head
`1b1a292f3009a49f422286d9a65cb4fc7e3fc254`; local `main` and
