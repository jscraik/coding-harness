...
`86c54830b8c1fda4620e4ce2f11c77bdcec84a29`, which is also the live PR #366
head after the tracker repair commit. PR #366 is open and `BLOCKED`: the live
PR body passes `pr-template-gate` locally after the PR description repair, and
fresh CircleCI plus CodeRabbit checks for pushed head `86c54830` are pending.
