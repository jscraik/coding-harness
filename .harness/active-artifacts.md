...
Current working reconciliation: 2026-06-08 current-main refresh for JSC-363.
PR #369 is merged into `main` as squash merge commit
`1d0c3baaa76d1de68c633b086a5dcf07472ddbef`; local `main` and `origin/main`
are synced at that commit. There is no active PR route lane. PU-013 runtime
cockpit integration proof is locally proved on branch
`codex/JSC-363-post-pr369-goal-state-refresh` at receipt head
`bdd89fac4e17995d182108339d1fc798ef6dc9ac`; no production code patch was
required. Delivery remains unclaimed until the proof tracker update is
committed, reviewed, merged, pulled back to local `main`, and Linear JSC-363 is
refreshed.
...
- JSC-363 is the current execution route for the Codex Runtime Evidence
  ...
  receipts. Historical compatibility evidence and PR #322 through PR #369 route
  ledgers are immutable provenance only; they are not current route truth. Current
  main route provenance is PR #369 merged into `main` as squash
  commit `1d0c3baaa76d1de68c633b086a5dcf07472ddbef`. There is no active PR
  route lane. PU-013 runtime cockpit integration proof is locally proved on
  branch `codex/JSC-363-post-pr369-goal-state-refresh` at receipt head
  `bdd89fac4e17995d182108339d1fc798ef6dc9ac` with no production code patch
  required. Delivery remains unclaimed until the proof tracker update is
  committed, reviewed, merged, pulled back to local `main`, and Linear JSC-363
  is refreshed. R149 records
