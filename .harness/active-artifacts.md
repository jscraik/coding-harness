...
Current working reconciliation: 2026-06-11 post-PR #405 pullback for JSC-363.
PR #405 merged the source-tracked post-PR #404 route-truth refresh into
`main` at `2118c189b62caff8ce197fc242c0253aab4ad3d5` from submitted head
`ca050543bb4906cef046649edcc94eba7f0feda2`; local `main` and
