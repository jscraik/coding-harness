...
Current working reconciliation: 2026-06-11 post-PR #406 pullback for JSC-363.
PR #406 merged the source-tracked post-PR #405 route-truth refresh into
`main` at `d0ae8ecfc78165690c9070aee3d66bfd7a85307a` from submitted head
`3964585ec6712de2deb248e8a9cc34531e6afd93`; local `main` and
