...
cockpit integration proof is queued for discussion, not active implementation.
Feature work remains stopped until this tracker refresh validates, the refreshed
state is committed, Linear JSC-363 is updated from current route truth, and Jamie
...
- JSC-363 is the current execution route for the Codex Runtime Evidence
  ...
  route lane. PU-013 is queued for discussion, not active implementation, until
  this tracker refresh validates, the refreshed state is committed, Linear
  JSC-363 is updated from compact route truth, and Jamie confirms the PU-013
  intent boundary. R149 records
