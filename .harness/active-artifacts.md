...
Current working reconciliation: 2026-06-06 on `main` after PR #356 merged.
JSC-395 advisory stale-document archive candidate reporting is delivered on
current main through PR #354; JSC-363 route truth is refreshed through PR #356. This route refresh does not claim live Linear,
release, downstream-template state, JSC-363 parent-goal completion, or
post-PR #356 tracker-current state; those remain separate closeout lanes. The
older JSC-363 cockpit route remains retained history and parent-goal context,
not a closed parent objective.

Last reconciled: 2026-06-06 after PR #356 merged into `main` as squash merge
commit `72a6e35bc0fb6c583b9d6d43636be91335a2f241` and local `main`
fast-forwarded to the same `origin/main` head. PR #356 submitted head
`1de6572f3ed6d4bb6ca5487cd0a4b12df79b4d8e` records the post-PR #354
route-truth refresh. PR #354 submitted head
...
PR #354, with 71 review threads and zero unresolved; PR #356 refreshed route truth with zero review threads and zero unresolved. The external Snyk GitHub
...
`prepare --apply` was not part of merged PR #350, PR #351, PR #352, PR #353, PR #354, or PR #356, so it
