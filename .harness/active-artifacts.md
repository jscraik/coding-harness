...
Current working reconciliation: 2026-06-09 post-PR381 merge pullback for
JSC-363. PR #381 is merged into `main` as squash merge commit
`14918c8d20df6da29f3b2531820da24405e727d2`; local `main` and `origin/main`
...
active after the PR #381 merge pullback; Linear field-text decision is active but blocked because Linear tools and LINEAR_API_KEY are unavailable in this session.
