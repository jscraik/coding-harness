...
`codex/jsc-363-next-clean-worktree-state`; no PR has been opened for this
branch yet. This route fixes a current-main `harness next` classifier bug where
