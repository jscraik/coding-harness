...
Current working reconciliation: 2026-06-11 post-PR #409 pullback for JSC-363.
PR #409 merged the PU-055 closeout matrix and route-truth repair into `main`
at `c3d476541351ccd08fb832d08ba9749a9f203e4c` from submitted head
`c5f4095bcd2484668acfa0195fdddf9e6cb2517e`; local `main` and
...
current active route is the PU-056 active-route runtime-card selection guard;
