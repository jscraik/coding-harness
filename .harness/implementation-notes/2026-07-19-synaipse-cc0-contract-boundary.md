...
artifact_id: synaipse-cc0-contract-boundary-compatibility-decision
artifact_type: implementation-note
canonical_slug: synaipse-cc0-contract-boundary-compatibility-decision
title: SynAIpse CC0 Contract Boundary And Compatibility Decision
harness_stage: implementation-notes
origin: SynAIpse CC0 producer-reader compatibility mapping
source_type: implementation-note
authority: execution-input
lifecycle_status: execution-input
canonical_destination: src/lib/synaipse/context-plane.ts
