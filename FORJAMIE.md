...
- [2026-04-03 - Command Failure Taxonomy (Why It Felt So Noisy)](#2026-04-03---command-failure-taxonomy-why-it-felt-so-noisy)
  - [Why so many "failures" showed up](#why-so-many-failures-showed-up)
  - [Improvements to reduce future churn](#improvements-to-reduce-future-churn)
- [2026-04-03 - Push Recovery Notes](#2026-04-03---push-recovery-notes)
  - [What blocked this branch](#what-blocked-this-branch)
  - [Fast recovery path next time](#fast-recovery-path-next-time)
- [2026-03-15 - CircleCI Closeout + Durability Sweep](#2026-03-15---circleci-closeout--durability-sweep)
  - [Plan / Annotation updates](#plan--annotation-updates)
  - [Durability fixes shipped in code + scaffold generation](#durability-fixes-shipped-in-code--scaffold-generation)
  - [Verification this pass](#verification-this-pass)
- [2026-03-14 - Transition Plan Status Refresh (Completed vs Remaining)](#2026-03-14---transition-plan-status-refresh-completed-vs-remaining)
  - [Marked Completed in Plan](#marked-completed-in-plan)
  - [Left to Do (Highest Impact)](#left-to-do-highest-impact)
  - [Repo Hygiene Updates Requested This Pass](#repo-hygiene-updates-requested-this-pass)
- [2026-03-22 - Harness Upgrade Guardrails](#2026-03-22---harness-upgrade-guardrails)
  - [What changed](#what-changed)
  - [Why it matters](#why-it-matters)
- [2026-03-31 - Pre-push Hook Fails In Fresh Temp Worktrees](#2026-03-31---pre-push-hook-fails-in-fresh-temp-worktrees)
  - [What happened](#what-happened-1)
  - [How we resolve it](#how-we-resolve-it)
