...
import {
	...
	createImproveCodebaseArchitectureGateResult,
	createSimplifyGateResult,
	createTestingReviewerGateResult,
	createUbiquitousLanguageGateResult,
	createUnslopifyGateResult,
	type HeEvidenceRef,
	type HeGateResult,
	...
	it("maps local skill and subagent artifacts into passing closeout gates", () => {
		const gates = [
			...
			createImproveCodebaseArchitectureGateResult({
				...
				evidenceRefs: gateEvidence("architecture-report", "skill"),
			...
			createUnslopifyGateResult({
				...
				evidenceRefs: gateEvidence("unslopify-report", "skill"),
			...
			createUbiquitousLanguageGateResult({
				...
				evidenceRefs: gateEvidence("ubiquitous-language-report", "skill"),
