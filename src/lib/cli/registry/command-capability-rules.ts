...
> = {
	...
	"agent-native-ratchets": "bootstrap-governance",
	"session-distill": "bootstrap-governance",
	"agent-rework": "bootstrap-governance",
	"reviewer-decision": "bootstrap-governance",
	"governance-decision-surface": "bootstrap-governance",
...
> = {
	...
	"agent-native-ratchets": "safe",
	"session-distill": "safe",
	"agent-rework": "safe",
	"reviewer-decision": "safe",
	"governance-decision-surface": "safe",
...
export const COMMAND_TIER_BY_NAME: Partial<Record<string, CommandTier>> = {
	...
	"agent-native-ratchets": "domain",
	"session-distill": "domain",
	"agent-rework": "domain",
	"reviewer-decision": "domain",
	"governance-decision-surface": "domain",
...
> = {
	...
	"agent-native-ratchets": "agent",
	"session-distill": "agent",
	"agent-rework": "agent",
	"reviewer-decision": "agent",
	"governance-decision-surface": "agent",
...
> = {
	...
	"agent-native-ratchets": ["next"],
	"session-distill": ["next"],
	"agent-rework": ["next"],
	"reviewer-decision": ["next"],
	"governance-decision-surface": ["next"],
...
export const AGENT_MODE_BY_NAME: Partial<Record<string, CommandAgentMode>> = {
	...
	"agent-native-ratchets": "orient",
	"session-distill": "orient",
	"agent-rework": "repair",
	"reviewer-decision": "review",
	"governance-decision-surface": "orient",
...
> = {
	...
	"agent-native-ratchets": "advanced",
	"session-distill": "advanced",
	"agent-rework": "advanced",
	"reviewer-decision": "advanced",
	"governance-decision-surface": "advanced",
