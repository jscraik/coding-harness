 ...
 *
 * @param schemaUrl - The $schema URL to parse (for example: "https://biomejs.dev/schemas/2.4.15/schema.json")
 * @returns The version string (e.g. "2.4.15") if present, `undefined` otherwise
 */
