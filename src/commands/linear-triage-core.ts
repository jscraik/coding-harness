...
/**
 * CLI options for `harness linear triage`.
 */
...
/**
 * Ranked triage recommendation for a single Linear issue.
 */
...
/**
 * Structured output returned by linear triage evaluation/apply runs.
 */
...
/**
 * Result envelope for linear triage operations.
 */
...
/**
 * Evaluates team backlog triage state and optionally applies promotions/labels.
 */
...
/**
 * CLI entrypoint wrapper for linear triage with exit-code mapping.
 */
