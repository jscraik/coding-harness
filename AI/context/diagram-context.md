...
Generated: 2026-05-23T11:29:36Z
...
- `src/commands/runtime-budget.ts`
...
- `src/lib/issue-loop/artifact-spine.ts`
...
- `src/lib/observability-gate/types.ts`
...
- `src/lib/remediate/cli-args.ts`
- `src/lib/remediate/types.ts`
...
- `src/lib/runtime/command-runtime-budget.ts`
...
flowchart LR
  ...
  subgraph DetectedLLM["Detected LLM clients"]
    ...
    det_detectedllm_cli_args_4_15572cd3["cli-args"]
  end
  ...
  subgraph DetectedTools["Agentic tool calls"]
    ...
    det_detectedtools_types_24_c63dc1a7["🔧 types"]
  end
...
flowchart TD
  ...
  cli_args_6_be6244ad["cli-args"]
  Untrusted --> cli_args_6_be6244ad
  runner_527aa9f4["runner"]
  Untrusted --> runner_527aa9f4
  types_25_89d086aa["types"]
  Untrusted --> types_25_89d086aa
  orchestrator_core_d0678b53["orchestrator-core"]
