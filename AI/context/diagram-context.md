...
Generated: 2026-07-11T13:27:14Z
...
- `src/lib/init/scaffold-gitbook-templates.ts`
- `src/lib/init/scaffold-surfaces.ts`
- `src/lib/init/scaffold-template-registry.ts`
- `src/templates/check-gitbook-readiness.mjs`
- `src/templates/circleci-config.yml`
- `src/templates/gitbook.yaml`
- `src/templates/gitbook/README.md`
- `src/templates/gitbook/SUMMARY.md`
- `src/templates/gitbook/architecture.md`
- `src/templates/gitbook/delivery-lifecycle.md`
- `src/templates/gitbook/trust-and-privacy.md`
