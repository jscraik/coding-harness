...
- `src/lib/browser-evidence/index.ts`
- `src/lib/browser-evidence/manifest-parser-helpers.ts`
- `src/lib/browser-evidence/manifest-parser-items.ts`
- `src/lib/browser-evidence/manifest-parser.ts`
- `src/lib/browser-evidence/png-inspection.ts`
- `src/lib/browser-evidence/png-test-fixtures.ts`
- `src/lib/browser-evidence/types.ts`
- `src/lib/browser-evidence/validator.ts`
- `src/lib/cli/registry/evidence-verify-command-spec.ts`
- `src/lib/cli/registry/evidence-verify-options.ts`
