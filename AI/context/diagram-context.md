...
Generated: 2026-06-04T22:18:05Z
...
- `package.json`
- `src/lib/docs-surface/docs-task-eval-contract.ts`
- `src/lib/docs-surface/docs-task-eval-fixtures.ts`
- `src/lib/docs-surface/docs-task-eval-validation.ts`
