...
Generated: 2026-06-13T18:24:47Z
...
- `src/lib/init/scaffold-package-command-template.ts`
- `src/lib/init/scaffold-script-template-registry.ts`
- `src/lib/policy/tooling-baseline.ts`
- `src/lib/runtime/command-version-probe.ts`
