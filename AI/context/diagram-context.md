...
Generated: 2026-07-21T00:00:32Z
...
- `src/dev/runtime-packet-schema-test-helpers.ts`
- `src/lib/decision/harness-decision-types.ts`
- `src/lib/decision/harness-decision-validation.ts`
- `src/lib/synaipse/context-failure-mapping.ts`
- `src/lib/synaipse/context-failures.ts`
- `src/lib/synaipse/context-plane.ts`
- `src/lib/synaipse/context-resolution-input.ts`
...
flowchart TD
  subgraph Orchestration["🎯 Orchestration Layer"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_prom_9a65eb91["🤖 prompt-context-drift-validate-runner"]
    node_agent_mmd_orchestration_layer_orchestration_prom_0cd46d14["🤖 prompt-context-drift-write-runner"]
    node_agent_mmd_orchestration_layer_orchestration_run__18817957["🤖 run-harness-evals"]
    validate_architecture_registries_bcbcdd34["🤖 validate-architecture-registries"]
    node_agent_mmd_orchestration_layer_orchestration_vali_c01b04be["🤖 validate-packaged-skill"]
    node_agent_mmd_orchestration_layer_orchestration_vali_5767880c["🤖 validate-prompt-context-drift"]
    node_agent_mmd_orchestration_layer_orchestration_writ_95aff91d["🤖 write-agent-native-ratchet-report"]
    node_agent_mmd_orchestration_layer_orchestration_writ_011f1ade["🤖 write-prompt-context-drift-report"]
    cli_99bb8840["🤖 cli"]
    ...
    execution_job_f0dd06de["🤖 execution-job"]
    execution_run_10a63344["🤖 execution-run"]
    fitness_9ebf9b59["🤖 fitness"]
    next_agent_native_ratchets_b7225496["🤖 next-agent-native-ratchets"]
    next_cli_evidence_2385bd04["🤖 next-cli-evidence"]
    next_decision_meta_c58bc91b["🤖 next-decision-meta"]
    next_operator_local_decision_6c2fc32f["🤖 next-operator-local-decision"]
    node_agent_mmd_orchestration_layer_orchestration_next_bd28cb25["🤖 next-prompt-context-drift"]
    node_agent_mmd_orchestration_layer_orchestration_next_2419fcae["🤖 next-recommendation-decisions"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_next_ac9a85a9["🤖 next-runner"]
    next_usage_errors_837a345a["🤖 next-usage-errors"]
    next_c6c1c9a9["🤖 next"]
    orient_ded57986["🤖 orient"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_prom_77706254["🤖 prompt-context-drift-surface"]
    repo_evidence_38bb1de5["🤖 repo-evidence"]
    safe_json_artifact_reader_9114b83f["🤖 safe-json-artifact-reader"]
    node_agent_mmd_orchestration_layer_orchestration_shar_724ef5f0["🤖 shared-state-policy"]
    status_073c1634["🤖 status"]
    node_agent_mmd_orchestration_layer_orchestration_test_286b7674["🤖 test-fixtures"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_comm_a5c828fb["🤖 command-agent-native-capability-rules"]
    node_agent_mmd_orchestration_layer_orchestration_comm_6e41a7f7["🤖 command-capabilities"]
    node_agent_mmd_orchestration_layer_orchestration_comm_40d7f90f["🤖 command-capability-rules"]
    node_agent_mmd_orchestration_layer_orchestration_comm_b10a44bc["🤖 command-expected-artifacts"]
    command_invocation_effects_execution_9409d7b5["🤖 command-invocation-effects-execution"]
    command_invocation_effects_job_15e1e317["🤖 command-invocation-effects-job"]
    node_agent_mmd_orchestration_layer_orchestration_comm_1f8cc24c["🤖 command-specs-core"]
    command_specs_69167c63["🤖 command-specs"]
    node_agent_mmd_orchestration_layer_orchestration_comm_a20f47f8["🤖 command-visibility-rules"]
    ...
    execution_run_options_2e517b5a["🤖 execution-run-options"]
    job_conductor_b96a6aaf["🤖 job-conductor"]
    local_coordinator_8833f242["🤖 local-coordinator"]
    process_executor_8cf100a9["🤖 process-executor"]
    base_lanes_d5d91b36["🤖 base-lanes"]
    commands_10f5f77e["🤖 commands"]
    coverage_c3a3091b["🤖 coverage"]
    optional_artifact_normalizers_7bdcc769["🤖 optional-artifact-normalizers"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_scaf_85b96e78["🤖 scaffold-gitbook-templates"]
    node_agent_mmd_orchestration_layer_orchestration_scaf_ff8f92f6["🤖 scaffold-template-registry"]
    types_17_ed30531c["🤖 types"]
    review_feedback_classifier_6debb753["🤖 review-feedback-classifier"]
    node_agent_mmd_orchestration_layer_orchestration_clas_899b821a["🤖 classifier"]
    node_agent_mmd_orchestration_layer_orchestration_coll_3a4e3b15["🤖 collector"]
    node_agent_mmd_orchestration_layer_orchestration_cont_1f93de91["🤖 context"]
    node_agent_mmd_orchestration_layer_orchestration_type_4f906dcc["🤖 types"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_tool_6fb851c8["🤖 tooling-paths"]
    ...
    node_agent_mmd_orchestration_layer_orchestration_prom_e7fa0708["🤖 prompt-context-drift-builder"]
    ...
    packet_caller_inventory_d1ceb372["🤖 packet-caller-inventory"]
    packet_consolidation_baseline_4008303d["🤖 packet-consolidation-baseline"]
    node_agent_mmd_orchestration_layer_orchestration_pack_b4abdaaf["🤖 packet-consolidation-contract"]
  ...
  subgraph LLMLayer["🧠 LLM / Model Layer"]
    ...
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_446877b9["💡 prompt-context-drift-validate-runner"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e635dbb5["💡 prompt-context-drift-write-runner"]
    ...
    node_agent_mmd_llm_model_layer_llmlayer_validate_prom_cde7017c["💡 validate-prompt-context-drift"]
    ...
    node_agent_mmd_llm_model_layer_llmlayer_write_prompt__42d2bbb0["💡 write-prompt-context-drift-report"]
    ...
    node_agent_mmd_llm_model_layer_llmlayer_next_prompt_c_bdfb9c8c["💡 next-prompt-context-drift"]
    node_agent_mmd_llm_model_layer_llmlayer_next_recommen_b2930791["💡 next-recommendation-decisions"]
    ...
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_a0dadf0c["💡 prompt-context-drift-surface"]
    node_agent_mmd_llm_model_layer_llmlayer_test_fixtures_44cf5600["💡 test-fixtures"]
    node_agent_mmd_llm_model_layer_llmlayer_builtin_comma_10020eed["💡 builtin-command-specs"]
    node_agent_mmd_llm_model_layer_llmlayer_command_expec_816d9b24["💡 command-expected-artifacts"]
    node_agent_mmd_llm_model_layer_llmlayer_command_specs_782af9fa["💡 command-specs-core"]
    pilot_evaluate_command_spec_1084ea72["💡 pilot-evaluate-command-spec"]
    pilot_rollback_command_spec_4fe69f7d["💡 pilot-rollback-command-spec"]
    ...
    node_agent_mmd_llm_model_layer_llmlayer_git_head_git__09437a5a["💡 git-head"]
    node_agent_mmd_llm_model_layer_llmlayer_index_index_1_02e160ff["💡 index"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_0bf03c2e["💡 prompt-context-drift-builder"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_9683b128["💡 prompt-context-drift-report"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e5066b88["💡 prompt-context-drift-types"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_304b3105["💡 prompt-context-drift-validation-evidence"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_18f9b062["💡 prompt-context-drift-validation-utils"]
    node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_b57d135a["💡 prompt-context-drift-validation"]
    node_agent_mmd_llm_model_layer_llmlayer_index_index_1_02e160ff["💡 index"]
  ...
  subgraph ToolLayer["🔧 Tool Layer"]
    ...
    next_pr_closeout_contract_af31d30a["🔧 next-pr-closeout-contract"]
    ...
    node_agent_mmd_tool_layer_toollayer_command_agent_nat_24f59b7b["🔧 command-agent-native-capability-rules"]
    node_agent_mmd_tool_layer_toollayer_command_capabilit_7fe13db1["🔧 command-capabilities"]
    node_agent_mmd_tool_layer_toollayer_command_capabilit_079c700e["🔧 command-capability-rules"]
    node_agent_mmd_tool_layer_toollayer_command_visibilit_709cf70d["🔧 command-visibility-rules"]
    ...
    node_agent_mmd_tool_layer_toollayer_tooling_paths_too_64483840["🔧 tooling-paths"]
    node_agent_mmd_tool_layer_toollayer_prompt_context_dr_801c86ff["🔧 prompt-context-drift-report"]
    node_agent_mmd_tool_layer_toollayer_prompt_context_dr_bd82da46["🔧 prompt-context-drift-types"]
    node_agent_mmd_tool_layer_toollayer_prompt_context_dr_0bf3d279["🔧 prompt-context-drift-validation-utils"]
    ...
    transition_contract_0732d034["🔧 transition-contract"]
    transition_recovery_validation_e06db55b["🔧 transition-recovery-validation"]
    transition_70dd37c1["🔧 transition"]
    index_17_642943a2["🔧 index"]
    projection_1b250ea1["🔧 projection"]
    types_40_c7e41f89["🔧 types"]
    validation_8_b9fa10af["🔧 validation"]
  end
  subgraph MemoryLayer["📚 Memory / Vector Layer"]
    check_gitbook_readiness_33bdca76[("📚 check-gitbook-readiness")]
    node_agent_mmd_memory_vector_layer_memorylayer_check__64c86928[("📚 check-steering-feedback-contract")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_5eeadd7c[("📚 prompt-context-drift-validate-runner")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_6d3fcb0b[("📚 prompt-context-drift-write-runner")]
    normalize_workflow_contracts_8701f1c8[("📚 normalize-workflow-contracts")]
    node_agent_mmd_memory_vector_layer_memorylayer_run_ha_5b637d0d[("📚 run-harness-evals")]
    sync_codex_preflight_7e7a8dc2[("📚 sync-codex-preflight")]
    test_harness_upgrade_matrix_84113c4e[("📚 test-harness-upgrade-matrix")]
    validate_harness_decision_semantics_3d63690b[("📚 validate-harness-decision-semantics")]
    node_agent_mmd_memory_vector_layer_memorylayer_valida_88b7435a[("📚 validate-prompt-context-drift")]
    ...
    node_agent_mmd_memory_vector_layer_memorylayer_write__bcc2ac9b[("📚 write-agent-native-ratchet-report")]
    node_agent_mmd_memory_vector_layer_memorylayer_write__9ee5aa99[("📚 write-prompt-context-drift-report")]
    ...
    next_orientation_meta_3a6af72b[("📚 next-orientation-meta")]
    node_agent_mmd_memory_vector_layer_memorylayer_next_p_25a3d4ff[("📚 next-prompt-context-drift")]
    node_agent_mmd_memory_vector_layer_memorylayer_next_r_ef64c9f9[("📚 next-recommendation-decisions")]
    node_agent_mmd_memory_vector_layer_memorylayer_next_r_7feb80cc[("📚 next-runner-state")]
    node_agent_mmd_memory_vector_layer_memorylayer_next_r_2c147e14[("📚 next-runner")]
    next_synaipse_context_8436b36b[("📚 next-synaipse-context")]
    ...
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_9133c81f[("📚 prompt-context-drift-surface")]
    node_agent_mmd_memory_vector_layer_memorylayer_test_f_1fee16ce[("📚 test-fixtures")]
    node_agent_mmd_memory_vector_layer_memorylayer_types__9ad640a0[("📚 types")]
    branch_protect_sync_570adb18[("📚 branch-protect-sync")]
    node_agent_mmd_memory_vector_layer_memorylayer_builti_434f5ddc[("📚 builtin-command-specs")]
    node_agent_mmd_memory_vector_layer_memorylayer_comman_3eb0cb39[("📚 command-capability-rules")]
    node_agent_mmd_memory_vector_layer_memorylayer_comman_7321aa84[("📚 command-expected-artifacts")]
    command_invocation_effects_fbc96da5[("📚 command-invocation-effects")]
    node_agent_mmd_memory_vector_layer_memorylayer_comman_111eb454[("📚 command-specs-core")]
    node_agent_mmd_memory_vector_layer_memorylayer_comman_659f8d49[("📚 command-visibility-rules")]
    ...
    harness_decision_types_6e63df74[("📚 harness-decision-types")]
    harness_decision_validation_3c4db687[("📚 harness-decision-validation")]
    ...
    node_agent_mmd_memory_vector_layer_memorylayer_scaffo_2cb917f1[("📚 scaffold-gitbook-templates")]
    ...
    review_learning_closeout_b7fa3b8e[("📚 review-learning-closeout")]
    ...
    node_agent_mmd_memory_vector_layer_memorylayer_collec_68f0d902[("📚 collector")]
    node_agent_mmd_memory_vector_layer_memorylayer_contex_78ceaaa9[("📚 context")]
    node_agent_mmd_memory_vector_layer_memorylayer_types__9ad640a0[("📚 types")]
    node_agent_mmd_memory_vector_layer_memorylayer_toolin_0b766498[("📚 tooling-paths")]
    ...
    node_agent_mmd_memory_vector_layer_memorylayer_git_he_543cbbc5[("📚 git-head")]
    node_agent_mmd_memory_vector_layer_memorylayer_index__752bc61e[("📚 index")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_b3bc9b07[("📚 prompt-context-drift-builder")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_84937d91[("📚 prompt-context-drift-report")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_efd77624[("📚 prompt-context-drift-types")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_09c6738a[("📚 prompt-context-drift-validation-evidence")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_e146d228[("📚 prompt-context-drift-validation-utils")]
    node_agent_mmd_memory_vector_layer_memorylayer_prompt_0340e365[("📚 prompt-context-drift-validation")]
    node_agent_mmd_memory_vector_layer_memorylayer_index__752bc61e[("📚 index")]
    ...
    cli_13_ae2ba749[("📚 cli")]
    collector_1_bc604d2a[("📚 collector")]
    types_36_674380ec[("📚 types")]
    context_contract_aaa6fb53[("📚 context-contract")]
    context_failure_mapping_3d71c384[("📚 context-failure-mapping")]
    context_failures_7633ffe2[("📚 context-failures")]
    context_observations_3c057ab7[("📚 context-observations")]
    context_plane_eb195522[("📚 context-plane")]
    context_privacy_d82295ee[("📚 context-privacy")]
    context_projection_e9599558[("📚 context-projection")]
    context_provider_51137c0d[("📚 context-provider")]
    context_resolution_input_93eb068b[("📚 context-resolution-input")]
    context_task_1d1d0361[("📚 context-task")]
    node_agent_mmd_memory_vector_layer_memorylayer_packet_8cb745e6[("📚 packet-consolidation-contract")]
    state_validation_8c9cb007[("📚 state-validation")]
    state_4ba69735[("📚 state")]
    overload_guard_2748c559[("📚 overload-guard")]
  end
  node_agent_mmd_memory_vector_layer_memorylayer_prompt_5eeadd7c -->|retrieves from| node_agent_mmd_memory_vector_layer_memorylayer_index__752bc61e
  node_agent_mmd_memory_vector_layer_memorylayer_prompt_6d3fcb0b -->|retrieves from| node_agent_mmd_memory_vector_layer_memorylayer_index__752bc61e
  classDef agentNode fill:#555,color:#fff
  class node_agent_mmd_orchestration_layer_orchestration_chec_7a9f0b64,node_agent_mmd_llm_model_layer_llmlayer_check_codex_a_29e7b7fa,node_agent_mmd_tool_layer_toollayer_check_codex_agent_4b361d5a,node_agent_mmd_orchestration_layer_orchestration_chec_7fd47f5c,node_agent_mmd_llm_model_layer_llmlayer_check_steerin_0e1bf90d,node_agent_mmd_tool_layer_toollayer_check_steering_fe_eafecf3a,node_agent_mmd_memory_vector_layer_memorylayer_check__64c86928,node_agent_mmd_orchestration_layer_orchestration_prom_9a65eb91,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_446877b9,node_agent_mmd_memory_vector_layer_memorylayer_prompt_5eeadd7c,node_agent_mmd_orchestration_layer_orchestration_prom_0cd46d14,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e635dbb5,node_agent_mmd_memory_vector_layer_memorylayer_prompt_6d3fcb0b,node_agent_mmd_orchestration_layer_orchestration_run__18817957,node_agent_mmd_llm_model_layer_llmlayer_run_harness_e_603fcfdc,node_agent_mmd_tool_layer_toollayer_run_harness_evals_e2ee24f1,node_agent_mmd_memory_vector_layer_memorylayer_run_ha_5b637d0d,validate_architecture_registries_bcbcdd34,node_agent_mmd_orchestration_layer_orchestration_vali_c01b04be,node_agent_mmd_llm_model_layer_llmlayer_validate_pack_2a12e1f4,node_agent_mmd_tool_layer_toollayer_validate_packaged_2855c827,node_agent_mmd_orchestration_layer_orchestration_vali_5767880c,node_agent_mmd_llm_model_layer_llmlayer_validate_prom_cde7017c,node_agent_mmd_memory_vector_layer_memorylayer_valida_88b7435a,node_agent_mmd_orchestration_layer_orchestration_writ_95aff91d,node_agent_mmd_memory_vector_layer_memorylayer_write__bcc2ac9b,node_agent_mmd_orchestration_layer_orchestration_writ_011f1ade,node_agent_mmd_llm_model_layer_llmlayer_write_prompt__42d2bbb0,node_agent_mmd_memory_vector_layer_memorylayer_write__9ee5aa99,cli_99bb8840,agent_readiness_c82c68e6,brain_core_aa07c380,brain_bbbf7a64,doctor_north_star_contract_checks_0048124c,doctor_roadmap_file_checks_14447b8e,doctor_72f4be89,drift_gate_rules_9685e72d,execution_job_f0dd06de,execution_run_10a63344,fitness_9ebf9b59,next_agent_native_ratchets_b7225496,next_cli_evidence_2385bd04,next_decision_meta_c58bc91b,next_operator_local_decision_6c2fc32f,node_agent_mmd_orchestration_layer_orchestration_next_bd28cb25,node_agent_mmd_llm_model_layer_llmlayer_next_prompt_c_bdfb9c8c,node_agent_mmd_memory_vector_layer_memorylayer_next_p_25a3d4ff,node_agent_mmd_orchestration_layer_orchestration_next_2419fcae,node_agent_mmd_llm_model_layer_llmlayer_next_recommen_b2930791,node_agent_mmd_memory_vector_layer_memorylayer_next_r_ef64c9f9,next_runner_inputs_754dba64,node_agent_mmd_orchestration_layer_orchestration_next_5393fba1,node_agent_mmd_memory_vector_layer_memorylayer_next_r_7feb80cc,node_agent_mmd_orchestration_layer_orchestration_next_ac9a85a9,node_agent_mmd_memory_vector_layer_memorylayer_next_r_2c147e14,next_usage_errors_837a345a,next_c6c1c9a9,orient_ded57986,remediate_findings_8b09c8c6,remediate_git_58c6f6f4,remediate_run_record_9dfe5dc1,node_agent_mmd_orchestration_layer_orchestration_reme_359fe98f,node_agent_mmd_llm_model_layer_llmlayer_remediate_run_9e3d4585,node_agent_mmd_tool_layer_toollayer_remediate_runner__c003b871,remediate_06b9c7fc,runtime_card_args_2b3d4b28,runtime_card_options_c9156ad5,runtime_card_e06b53e1,node_agent_mmd_orchestration_layer_orchestration_tool_acfe0c01,node_agent_mmd_memory_vector_layer_memorylayer_toolin_a1185b8f,upgrade_7fef9479,active_route_refs_d7a46846,node_agent_mmd_orchestration_layer_orchestration_chec_0550c395,node_agent_mmd_tool_layer_toollayer_checker_checker_2_453d593b,node_agent_mmd_memory_vector_layer_memorylayer_checke_a583eb4f,cli_1_084e05fe,node_agent_mmd_orchestration_layer_orchestration_cont_61b3b9c9,node_agent_mmd_llm_model_layer_llmlayer_context_healt_cfc0bfa8,node_agent_mmd_memory_vector_layer_memorylayer_contex_3204aa0e,package_scripts_3ee6150f,node_agent_mmd_orchestration_layer_orchestration_prom_77706254,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_a0dadf0c,node_agent_mmd_memory_vector_layer_memorylayer_prompt_9133c81f,repo_evidence_38bb1de5,safe_json_artifact_reader_9114b83f,node_agent_mmd_orchestration_layer_orchestration_shar_724ef5f0,node_agent_mmd_tool_layer_toollayer_shared_state_poli_53734acd,status_073c1634,node_agent_mmd_orchestration_layer_orchestration_test_286b7674,node_agent_mmd_llm_model_layer_llmlayer_test_fixtures_44cf5600,node_agent_mmd_memory_vector_layer_memorylayer_test_f_1fee16ce,node_agent_mmd_orchestration_layer_orchestration_type_4f906dcc,node_agent_mmd_memory_vector_layer_memorylayer_types__9ad640a0,agent_native_packet_command_specs_5e921752,agent_readiness_command_spec_a30c2c1e,brain_command_spec_15b122d5,command_agent_catalog_rules_8e06b2af,node_agent_mmd_orchestration_layer_orchestration_comm_a5c828fb,node_agent_mmd_tool_layer_toollayer_command_agent_nat_24f59b7b,node_agent_mmd_orchestration_layer_orchestration_comm_6e41a7f7,node_agent_mmd_tool_layer_toollayer_command_capabilit_7fe13db1,node_agent_mmd_orchestration_layer_orchestration_comm_40d7f90f,node_agent_mmd_tool_layer_toollayer_command_capabilit_079c700e,node_agent_mmd_memory_vector_layer_memorylayer_comman_3eb0cb39,node_agent_mmd_orchestration_layer_orchestration_comm_b10a44bc,node_agent_mmd_llm_model_layer_llmlayer_command_expec_816d9b24,node_agent_mmd_memory_vector_layer_memorylayer_comman_7321aa84,command_invocation_effects_execution_9409d7b5,command_invocation_effects_job_15e1e317,node_agent_mmd_orchestration_layer_orchestration_comm_1f8cc24c,node_agent_mmd_llm_model_layer_llmlayer_command_specs_782af9fa,node_agent_mmd_memory_vector_layer_memorylayer_comman_111eb454,command_specs_69167c63,node_agent_mmd_orchestration_layer_orchestration_comm_a20f47f8,node_agent_mmd_tool_layer_toollayer_command_visibilit_709cf70d,node_agent_mmd_memory_vector_layer_memorylayer_comman_659f8d49,node_agent_mmd_orchestration_layer_orchestration_line_b67affd5,node_agent_mmd_tool_layer_toollayer_linear_command_ru_d6763748,linear_command_spec_1e12dd44,upgrade_command_spec_03f6c7bd,north_star_alignment_00440188,node_agent_mmd_orchestration_layer_orchestration_poli_3270b55d,node_agent_mmd_tool_layer_toollayer_policy_validators_af136abf,node_agent_mmd_memory_vector_layer_memorylayer_policy_1944de42,run_records_core_89286dfa,node_agent_mmd_orchestration_layer_orchestration_type_7cf81261,node_agent_mmd_tool_layer_toollayer_types_core_types__6c8319b6,node_agent_mmd_memory_vector_layer_memorylayer_types__83f369fa,node_agent_mmd_orchestration_layer_orchestration_vali_d9fe99e6,node_agent_mmd_tool_layer_toollayer_validator_core_va_6ef6131f,node_agent_mmd_memory_vector_layer_memorylayer_valida_41034356,node_agent_mmd_orchestration_layer_orchestration_he_p_fc778c24,node_agent_mmd_tool_layer_toollayer_he_phase_exit_cor_af016160,execution_run_options_2e517b5a,job_conductor_b96a6aaf,local_coordinator_8833f242,process_executor_8cf100a9,base_lanes_d5d91b36,commands_10f5f77e,coverage_c3a3091b,optional_artifact_normalizers_7bdcc769,node_agent_mmd_orchestration_layer_orchestration_init_2a9c3ecb,node_agent_mmd_memory_vector_layer_memorylayer_init_m_333d02c5,node_agent_mmd_orchestration_layer_orchestration_proj_6ab6f60f,node_agent_mmd_memory_vector_layer_memorylayer_projec_3ae304d9,node_agent_mmd_orchestration_layer_orchestration_scaf_12cc07db,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_5fd73b94,node_agent_mmd_orchestration_layer_orchestration_scaf_c9a90c2f,node_agent_mmd_tool_layer_toollayer_scaffold_environm_c1afc013,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_12b42341,node_agent_mmd_orchestration_layer_orchestration_scaf_85b96e78,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_2cb917f1,node_agent_mmd_orchestration_layer_orchestration_scaf_ff8f92f6,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_a86eece1,types_17_ed30531c,review_feedback_classifier_6debb753,node_agent_mmd_orchestration_layer_orchestration_clas_899b821a,node_agent_mmd_memory_vector_layer_memorylayer_classi_1ebbf5ff,node_agent_mmd_orchestration_layer_orchestration_coll_3a4e3b15,node_agent_mmd_memory_vector_layer_memorylayer_collec_68f0d902,node_agent_mmd_orchestration_layer_orchestration_cont_1f93de91,node_agent_mmd_memory_vector_layer_memorylayer_contex_78ceaaa9,control_plane_core_db3b4cb2,metrics_capture_core_db4bf7cf,registries_06402afa,lifecycle_intent_test_fixtures_a53c7ada,node_agent_mmd_orchestration_layer_orchestration_tool_6fb851c8,node_agent_mmd_tool_layer_toollayer_tooling_paths_too_64483840,node_agent_mmd_memory_vector_layer_memorylayer_toolin_0b766498,add_cli_7614de25,brain_validator_be251832,cli_args_8_d546936e,cli_types_1686e858,cli_value_flags_732a8e43,cli_11_338a8415,domain_mapper_cd9333d2,help_106a5842,lint_attachments_873c0632,lint_checks_83522b19,lint_cli_9ec62ec0,lint_pages_e33301d0,lint_types_2862c255,metadata_scanner_6a101b66,preflight_cli_5d148379,query_cli_b95be64d,query_presenter_02e6077c,rules_6c621d1a,stale_cli_64548720,stale_presenter_1de4e3a2,status_cli_4c24a0d6,status_presenter_8de686c1,node_agent_mmd_orchestration_layer_orchestration_sugg_85c5ebe3,node_agent_mmd_memory_vector_layer_memorylayer_sugges_267f408d,node_agent_mmd_orchestration_layer_orchestration_prom_e7fa0708,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_0bf03c2e,node_agent_mmd_memory_vector_layer_memorylayer_prompt_b3bc9b07,node_agent_mmd_orchestration_layer_orchestration_prom_77088997,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e5066b88,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_bd82da46,node_agent_mmd_memory_vector_layer_memorylayer_prompt_efd77624,orchestrator_11376b7e,eval_runner_0966a6b3,runtime_card_trace_64a5ca95,codex_runtime_evidence_types_f55808dd,codex_runtime_evidence_validation_sections_6d236b4a,runtime_evidence_contract_validation_sections_1779ca7c,runtime_evidence_contract_0f7b15b2,analysis_f44e85c4,packet_caller_inventory_d1ceb372,packet_consolidation_baseline_4008303d,node_agent_mmd_orchestration_layer_orchestration_pack_b4abdaaf,node_agent_mmd_memory_vector_layer_memorylayer_packet_8cb745e6,runner_527aa9f4,verify_work_1_cd8e7ec3,cli_args_14_3481043e,runner_1_6f281bf8,orchestrator_core_d0678b53,orchestrator_1_6b7137c5 agentNode
  classDef llmNode fill:#555,color:#fff
  class node_agent_mmd_orchestration_layer_orchestration_chec_7a9f0b64,node_agent_mmd_llm_model_layer_llmlayer_check_codex_a_29e7b7fa,node_agent_mmd_tool_layer_toollayer_check_codex_agent_4b361d5a,node_agent_mmd_orchestration_layer_orchestration_chec_7fd47f5c,node_agent_mmd_llm_model_layer_llmlayer_check_steerin_0e1bf90d,node_agent_mmd_tool_layer_toollayer_check_steering_fe_eafecf3a,node_agent_mmd_memory_vector_layer_memorylayer_check__64c86928,node_agent_mmd_orchestration_layer_orchestration_prom_9a65eb91,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_446877b9,node_agent_mmd_memory_vector_layer_memorylayer_prompt_5eeadd7c,node_agent_mmd_orchestration_layer_orchestration_prom_0cd46d14,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e635dbb5,node_agent_mmd_memory_vector_layer_memorylayer_prompt_6d3fcb0b,node_agent_mmd_orchestration_layer_orchestration_run__18817957,node_agent_mmd_llm_model_layer_llmlayer_run_harness_e_603fcfdc,node_agent_mmd_tool_layer_toollayer_run_harness_evals_e2ee24f1,node_agent_mmd_memory_vector_layer_memorylayer_run_ha_5b637d0d,validate_decision_request_2e5c325e,validate_goal_completion_audit_receipt_100d252c,node_agent_mmd_orchestration_layer_orchestration_vali_c01b04be,node_agent_mmd_llm_model_layer_llmlayer_validate_pack_2a12e1f4,node_agent_mmd_tool_layer_toollayer_validate_packaged_2855c827,node_agent_mmd_orchestration_layer_orchestration_vali_5767880c,node_agent_mmd_llm_model_layer_llmlayer_validate_prom_cde7017c,node_agent_mmd_memory_vector_layer_memorylayer_valida_88b7435a,validate_reviewer_coverage_251efee3,node_agent_mmd_llm_model_layer_llmlayer_validate_syst_5636156e,node_agent_mmd_memory_vector_layer_memorylayer_valida_db599a97,node_agent_mmd_orchestration_layer_orchestration_writ_011f1ade,node_agent_mmd_llm_model_layer_llmlayer_write_prompt__42d2bbb0,node_agent_mmd_memory_vector_layer_memorylayer_write__9ee5aa99,check_environment_core_2c16213f,node_agent_mmd_llm_model_layer_llmlayer_context_conte_ad2dfbd9,node_agent_mmd_memory_vector_layer_memorylayer_contex_78ceaaa9,node_agent_mmd_llm_model_layer_llmlayer_index_context_1041bd11,node_agent_mmd_memory_vector_layer_memorylayer_index__6f3402d0,node_agent_mmd_orchestration_layer_orchestration_next_bd28cb25,node_agent_mmd_llm_model_layer_llmlayer_next_prompt_c_bdfb9c8c,node_agent_mmd_memory_vector_layer_memorylayer_next_p_25a3d4ff,node_agent_mmd_orchestration_layer_orchestration_next_2419fcae,node_agent_mmd_llm_model_layer_llmlayer_next_recommen_b2930791,node_agent_mmd_memory_vector_layer_memorylayer_next_r_ef64c9f9,prompt_gate_c5e9d207,node_agent_mmd_orchestration_layer_orchestration_reme_359fe98f,node_agent_mmd_llm_model_layer_llmlayer_remediate_run_9e3d4585,node_agent_mmd_tool_layer_toollayer_remediate_runner__c003b871,node_agent_mmd_llm_model_layer_llmlayer_search_search_66b9a911,node_agent_mmd_memory_vector_layer_memorylayer_search_ac35cb7e,node_agent_mmd_orchestration_layer_orchestration_cont_61b3b9c9,node_agent_mmd_llm_model_layer_llmlayer_context_healt_cfc0bfa8,node_agent_mmd_memory_vector_layer_memorylayer_contex_3204aa0e,node_agent_mmd_orchestration_layer_orchestration_prom_77706254,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_a0dadf0c,node_agent_mmd_memory_vector_layer_memorylayer_prompt_9133c81f,node_agent_mmd_orchestration_layer_orchestration_test_286b7674,node_agent_mmd_llm_model_layer_llmlayer_test_fixtures_44cf5600,node_agent_mmd_memory_vector_layer_memorylayer_test_f_1fee16ce,node_agent_mmd_llm_model_layer_llmlayer_builtin_comma_10020eed,node_agent_mmd_memory_vector_layer_memorylayer_builti_434f5ddc,node_agent_mmd_orchestration_layer_orchestration_comm_b10a44bc,node_agent_mmd_llm_model_layer_llmlayer_command_expec_816d9b24,node_agent_mmd_memory_vector_layer_memorylayer_comman_7321aa84,node_agent_mmd_orchestration_layer_orchestration_comm_1f8cc24c,node_agent_mmd_llm_model_layer_llmlayer_command_specs_782af9fa,node_agent_mmd_memory_vector_layer_memorylayer_comman_111eb454,pilot_evaluate_command_spec_1084ea72,pilot_rollback_command_spec_4fe69f7d,prompt_gate_command_spec_9a941482,node_agent_mmd_llm_model_layer_llmlayer_constants_con_c9bd3f6c,node_agent_mmd_memory_vector_layer_memorylayer_consta_702d3f46,node_agent_mmd_llm_model_layer_llmlayer_index_index_1_02e160ff,node_agent_mmd_memory_vector_layer_memorylayer_index__752bc61e,node_agent_mmd_llm_model_layer_llmlayer_indexer_index_4f4deef5,node_agent_mmd_memory_vector_layer_memorylayer_indexe_93e6d86f,node_agent_mmd_llm_model_layer_llmlayer_ollama_ollama_968b23fa,node_agent_mmd_memory_vector_layer_memorylayer_ollama_6d51be16,node_agent_mmd_llm_model_layer_llmlayer_sync_contract_9f3cc8c1,node_agent_mmd_memory_vector_layer_memorylayer_sync_c_e43418bc,north_star_validators_cfc926ce,hilt_boundary_9b36fb15,types_10_75e5a4a0,goal_completion_audit_receipt_validation_9d0f4891,goal_completion_audit_receipt_5e4939c3,index_5_522f772a,node_agent_mmd_tool_layer_toollayer_constants_constan_9d71b829,types_18_37582e2a,sensitive_text_7c11f760,pr_template_linked_issue_relationship_a7b61f2c,pr_template_validator_rules_20a32d6b,node_agent_mmd_llm_model_layer_llmlayer_git_head_git__09437a5a,node_agent_mmd_memory_vector_layer_memorylayer_git_he_543cbbc5,node_agent_mmd_orchestration_layer_orchestration_prom_e7fa0708,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_0bf03c2e,node_agent_mmd_memory_vector_layer_memorylayer_prompt_b3bc9b07,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_9683b128,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_801c86ff,node_agent_mmd_memory_vector_layer_memorylayer_prompt_84937d91,node_agent_mmd_orchestration_layer_orchestration_prom_77088997,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e5066b88,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_bd82da46,node_agent_mmd_memory_vector_layer_memorylayer_prompt_efd77624,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_304b3105,node_agent_mmd_memory_vector_layer_memorylayer_prompt_09c6738a,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_18f9b062,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_0bf3d279,node_agent_mmd_memory_vector_layer_memorylayer_prompt_e146d228,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_b57d135a,node_agent_mmd_memory_vector_layer_memorylayer_prompt_0340e365,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_6426acc2,node_agent_mmd_memory_vector_layer_memorylayer_prompt_55c0d605,cli_args_9_9c136878,cli_12_01c06c37,sections_4697ef32,types_29_929d5a70,validator_7_f836eb0e,cli_args_10_861cdd3f llmNode
  classDef toolNode fill:#555,color:#fff
  class node_agent_mmd_orchestration_layer_orchestration_chec_7a9f0b64,node_agent_mmd_llm_model_layer_llmlayer_check_codex_a_29e7b7fa,node_agent_mmd_tool_layer_toollayer_check_codex_agent_4b361d5a,node_agent_mmd_orchestration_layer_orchestration_chec_7fd47f5c,node_agent_mmd_llm_model_layer_llmlayer_check_steerin_0e1bf90d,node_agent_mmd_tool_layer_toollayer_check_steering_fe_eafecf3a,node_agent_mmd_memory_vector_layer_memorylayer_check__64c86928,check_tooling_baseline_parity_3124b30a,node_agent_mmd_orchestration_layer_orchestration_run__18817957,node_agent_mmd_llm_model_layer_llmlayer_run_harness_e_603fcfdc,node_agent_mmd_tool_layer_toollayer_run_harness_evals_e2ee24f1,node_agent_mmd_memory_vector_layer_memorylayer_run_ha_5b637d0d,validate_action_review_receipt_fa2f06c3,node_agent_mmd_orchestration_layer_orchestration_vali_c01b04be,node_agent_mmd_llm_model_layer_llmlayer_validate_pack_2a12e1f4,node_agent_mmd_tool_layer_toollayer_validate_packaged_2855c827,validate_replay_packet_f309747e,node_agent_mmd_tool_layer_toollayer_ci_migrate_core_c_049f8460,node_agent_mmd_memory_vector_layer_memorylayer_ci_mig_0cd5b1a4,doctor_checks_5a2eb2b9,doctor_github_tool_check_e0a938df,doctor_github_tool_checks_a53b0382,doctor_tool_checks_4acac51a,fleet_plan_repo_ecdc6499,next_blocked_decisions_4140ad2b,next_pr_closeout_contract_af31d30a,policy_gate_213f7313,remediate_cli_output_cc165396,node_agent_mmd_orchestration_layer_orchestration_reme_359fe98f,node_agent_mmd_llm_model_layer_llmlayer_remediate_run_9e3d4585,node_agent_mmd_tool_layer_toollayer_remediate_runner__c003b871,node_agent_mmd_tool_layer_toollayer_review_gate_core__7704598b,node_agent_mmd_memory_vector_layer_memorylayer_review_5bee9816,index_1bc04b52,types_1_4ecdf56e,validation_constants_e002a0f6,validation_98c41dcd,node_agent_mmd_orchestration_layer_orchestration_chec_0550c395,node_agent_mmd_tool_layer_toollayer_checker_checker_2_453d593b,node_agent_mmd_memory_vector_layer_memorylayer_checke_a583eb4f,node_agent_mmd_orchestration_layer_orchestration_shar_724ef5f0,node_agent_mmd_tool_layer_toollayer_shared_state_poli_53734acd,cli_args_1_6144b055,node_agent_mmd_orchestration_layer_orchestration_comm_a5c828fb,node_agent_mmd_tool_layer_toollayer_command_agent_nat_24f59b7b,node_agent_mmd_orchestration_layer_orchestration_comm_6e41a7f7,node_agent_mmd_tool_layer_toollayer_command_capabilit_7fe13db1,node_agent_mmd_orchestration_layer_orchestration_comm_40d7f90f,node_agent_mmd_tool_layer_toollayer_command_capabilit_079c700e,node_agent_mmd_memory_vector_layer_memorylayer_comman_3eb0cb39,node_agent_mmd_orchestration_layer_orchestration_comm_a20f47f8,node_agent_mmd_tool_layer_toollayer_command_visibilit_709cf70d,node_agent_mmd_memory_vector_layer_memorylayer_comman_659f8d49,linear_command_actions_e430f4f4,node_agent_mmd_orchestration_layer_orchestration_line_b67affd5,node_agent_mmd_tool_layer_toollayer_linear_command_ru_d6763748,node_agent_mmd_orchestration_layer_orchestration_poli_3270b55d,node_agent_mmd_tool_layer_toollayer_policy_validators_af136abf,node_agent_mmd_memory_vector_layer_memorylayer_policy_1944de42,shared_state_action_validator_e7b128cd,node_agent_mmd_orchestration_layer_orchestration_type_7cf81261,node_agent_mmd_tool_layer_toollayer_types_core_types__6c8319b6,node_agent_mmd_memory_vector_layer_memorylayer_types__83f369fa,node_agent_mmd_orchestration_layer_orchestration_vali_d9fe99e6,node_agent_mmd_tool_layer_toollayer_validator_core_va_6ef6131f,node_agent_mmd_memory_vector_layer_memorylayer_valida_41034356,validator_helpers_7b927667,node_agent_mmd_orchestration_layer_orchestration_he_p_fc778c24,node_agent_mmd_tool_layer_toollayer_he_phase_exit_cor_af016160,environment_runtime_3206f0a8,observed_skill_usage_ed7d5930,closure_evidence_aaa31467,pr_creator_dc6b1ea4,client_948fe603,init_output_360dce91,scaffold_ci_templates_2afd6392,scaffold_codex_environment_templates_334fbbed,scaffold_config_templates_4b80ce53,node_agent_mmd_orchestration_layer_orchestration_scaf_c9a90c2f,node_agent_mmd_tool_layer_toollayer_scaffold_environm_c1afc013,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_12b42341,scaffold_github_actions_pr_pipeline_renderer_1ee18de5,scaffold_github_actions_pr_pipeline_template_e2b85f62,scaffold_package_command_template_80e32e83,scaffold_release_private_npm_template_075499f8,node_agent_mmd_llm_model_layer_llmlayer_constants_con_c9bd3f6c,node_agent_mmd_tool_layer_toollayer_constants_constan_9d71b829,index_9_32dd4d91,validation_common_6161e48b,node_agent_mmd_tool_layer_toollayer_cli_cli_2_1_32d9eeaf,node_agent_mmd_memory_vector_layer_memorylayer_cli_cl_1f1f89ab,node_agent_mmd_tool_layer_toollayer_metrics_tracker_m_4c9237d8,node_agent_mmd_memory_vector_layer_memorylayer_metric_12562178,normalise_renderer_85f2e563,evaluation_engine_core_e054fe49,tooling_baseline_50ab2eeb,node_agent_mmd_orchestration_layer_orchestration_tool_6fb851c8,node_agent_mmd_tool_layer_toollayer_tooling_paths_too_64483840,node_agent_mmd_memory_vector_layer_memorylayer_toolin_0b766498,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_9683b128,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_801c86ff,node_agent_mmd_memory_vector_layer_memorylayer_prompt_84937d91,node_agent_mmd_orchestration_layer_orchestration_prom_77088997,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e5066b88,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_bd82da46,node_agent_mmd_memory_vector_layer_memorylayer_prompt_efd77624,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_18f9b062,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_0bf3d279,node_agent_mmd_memory_vector_layer_memorylayer_prompt_e146d228,replay_packet_a1293f88,index_14_d982116c,review_lifecycle_contract_e5447221,review_lifecycle_89afa64c,node_agent_mmd_tool_layer_toollayer_runtime_card_code_3636ceac,node_agent_mmd_memory_vector_layer_memorylayer_runtim_a5d23e7f,runtime_card_codex_runtime_0655e230,runtime_evidence_bundle_d471a232,types_38_e8efcd57,transition_contract_0732d034,transition_recovery_validation_e06db55b,transition_70dd37c1,index_17_642943a2,projection_1b250ea1,types_40_c7e41f89,validation_8_b9fa10af toolNode
  classDef memNode fill:#555,color:#fff
  class check_gitbook_readiness_33bdca76,node_agent_mmd_orchestration_layer_orchestration_chec_7fd47f5c,node_agent_mmd_llm_model_layer_llmlayer_check_steerin_0e1bf90d,node_agent_mmd_tool_layer_toollayer_check_steering_fe_eafecf3a,node_agent_mmd_memory_vector_layer_memorylayer_check__64c86928,node_agent_mmd_orchestration_layer_orchestration_prom_9a65eb91,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_446877b9,node_agent_mmd_memory_vector_layer_memorylayer_prompt_5eeadd7c,node_agent_mmd_orchestration_layer_orchestration_prom_0cd46d14,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e635dbb5,node_agent_mmd_memory_vector_layer_memorylayer_prompt_6d3fcb0b,normalize_workflow_contracts_8701f1c8,node_agent_mmd_orchestration_layer_orchestration_run__18817957,node_agent_mmd_llm_model_layer_llmlayer_run_harness_e_603fcfdc,node_agent_mmd_tool_layer_toollayer_run_harness_evals_e2ee24f1,node_agent_mmd_memory_vector_layer_memorylayer_run_ha_5b637d0d,sync_codex_preflight_7e7a8dc2,test_harness_upgrade_matrix_84113c4e,validate_harness_decision_semantics_3d63690b,node_agent_mmd_orchestration_layer_orchestration_vali_5767880c,node_agent_mmd_llm_model_layer_llmlayer_validate_prom_cde7017c,node_agent_mmd_memory_vector_layer_memorylayer_valida_88b7435a,validate_runtime_packet_schemas_bc3ba8ec,node_agent_mmd_llm_model_layer_llmlayer_validate_syst_5636156e,node_agent_mmd_memory_vector_layer_memorylayer_valida_db599a97,validate_workflow_contracts_33dc063c,node_agent_mmd_orchestration_layer_orchestration_writ_95aff91d,node_agent_mmd_memory_vector_layer_memorylayer_write__bcc2ac9b,node_agent_mmd_orchestration_layer_orchestration_writ_011f1ade,node_agent_mmd_llm_model_layer_llmlayer_write_prompt__42d2bbb0,node_agent_mmd_memory_vector_layer_memorylayer_write__9ee5aa99,branch_protect_core_a8feb0fd,node_agent_mmd_tool_layer_toollayer_ci_migrate_core_c_049f8460,node_agent_mmd_memory_vector_layer_memorylayer_ci_mig_0cd5b1a4,context_health_80bb7da9,node_agent_mmd_llm_model_layer_llmlayer_context_conte_ad2dfbd9,node_agent_mmd_memory_vector_layer_memorylayer_contex_78ceaaa9,docs_gate_classification_2f51c90b,docs_gate_types_d285abb6,node_agent_mmd_llm_model_layer_llmlayer_index_context_1041bd11,node_agent_mmd_memory_vector_layer_memorylayer_index__6f3402d0,local_memory_preflight_dcc36c42,memory_gate_a577a506,next_orientation_meta_3a6af72b,node_agent_mmd_orchestration_layer_orchestration_next_bd28cb25,node_agent_mmd_llm_model_layer_llmlayer_next_prompt_c_bdfb9c8c,node_agent_mmd_memory_vector_layer_memorylayer_next_p_25a3d4ff,node_agent_mmd_orchestration_layer_orchestration_next_2419fcae,node_agent_mmd_llm_model_layer_llmlayer_next_recommen_b2930791,node_agent_mmd_memory_vector_layer_memorylayer_next_r_ef64c9f9,node_agent_mmd_orchestration_layer_orchestration_next_5393fba1,node_agent_mmd_memory_vector_layer_memorylayer_next_r_7feb80cc,node_agent_mmd_orchestration_layer_orchestration_next_ac9a85a9,node_agent_mmd_memory_vector_layer_memorylayer_next_r_2c147e14,next_synaipse_context_8436b36b,pattern_scope_siblings_43abe000,review_context_ca6cf81d,node_agent_mmd_tool_layer_toollayer_review_gate_core__7704598b,node_agent_mmd_memory_vector_layer_memorylayer_review_5bee9816,node_agent_mmd_llm_model_layer_llmlayer_search_search_66b9a911,node_agent_mmd_memory_vector_layer_memorylayer_search_ac35cb7e,session_context_e5ec72c0,node_agent_mmd_orchestration_layer_orchestration_tool_acfe0c01,node_agent_mmd_memory_vector_layer_memorylayer_toolin_a1185b8f,run_local_memory_preflight_36e92808,node_agent_mmd_orchestration_layer_orchestration_chec_0550c395,node_agent_mmd_tool_layer_toollayer_checker_checker_2_453d593b,node_agent_mmd_memory_vector_layer_memorylayer_checke_a583eb4f,node_agent_mmd_orchestration_layer_orchestration_cont_61b3b9c9,node_agent_mmd_llm_model_layer_llmlayer_context_healt_cfc0bfa8,node_agent_mmd_memory_vector_layer_memorylayer_contex_3204aa0e,node_agent_mmd_orchestration_layer_orchestration_prom_77706254,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_a0dadf0c,node_agent_mmd_memory_vector_layer_memorylayer_prompt_9133c81f,node_agent_mmd_orchestration_layer_orchestration_test_286b7674,node_agent_mmd_llm_model_layer_llmlayer_test_fixtures_44cf5600,node_agent_mmd_memory_vector_layer_memorylayer_test_f_1fee16ce,node_agent_mmd_orchestration_layer_orchestration_type_4f906dcc,node_agent_mmd_memory_vector_layer_memorylayer_types__9ad640a0,branch_protect_sync_570adb18,node_agent_mmd_llm_model_layer_llmlayer_builtin_comma_10020eed,node_agent_mmd_memory_vector_layer_memorylayer_builti_434f5ddc,node_agent_mmd_orchestration_layer_orchestration_comm_40d7f90f,node_agent_mmd_tool_layer_toollayer_command_capabilit_079c700e,node_agent_mmd_memory_vector_layer_memorylayer_comman_3eb0cb39,node_agent_mmd_orchestration_layer_orchestration_comm_b10a44bc,node_agent_mmd_llm_model_layer_llmlayer_command_expec_816d9b24,node_agent_mmd_memory_vector_layer_memorylayer_comman_7321aa84,command_invocation_effects_fbc96da5,node_agent_mmd_orchestration_layer_orchestration_comm_1f8cc24c,node_agent_mmd_llm_model_layer_llmlayer_command_specs_782af9fa,node_agent_mmd_memory_vector_layer_memorylayer_comman_111eb454,node_agent_mmd_orchestration_layer_orchestration_comm_a20f47f8,node_agent_mmd_tool_layer_toollayer_command_visibilit_709cf70d,node_agent_mmd_memory_vector_layer_memorylayer_comman_659f8d49,local_memory_preflight_command_spec_9e23f3ce,memory_gate_command_spec_dc9001a9,review_gate_command_spec_3187376a,session_context_command_spec_973afbb1,node_agent_mmd_llm_model_layer_llmlayer_constants_con_c9bd3f6c,node_agent_mmd_memory_vector_layer_memorylayer_consta_702d3f46,context_compact_policy_3dcaf95d,node_agent_mmd_llm_model_layer_llmlayer_index_index_1_02e160ff,node_agent_mmd_memory_vector_layer_memorylayer_index__752bc61e,node_agent_mmd_llm_model_layer_llmlayer_indexer_index_4f4deef5,node_agent_mmd_memory_vector_layer_memorylayer_indexe_93e6d86f,init_error_5c7dd49f,lexical_fallback_723e2b3e,node_agent_mmd_llm_model_layer_llmlayer_ollama_ollama_968b23fa,node_agent_mmd_memory_vector_layer_memorylayer_ollama_6d51be16,rollout_a4fa034c,sources_878a52fc,store_824d80d7,node_agent_mmd_llm_model_layer_llmlayer_sync_contract_9f3cc8c1,node_agent_mmd_memory_vector_layer_memorylayer_sync_c_e43418bc,types_8_f6283648,harness_run_context_ac7c77a9,index_4_013aa0e3,json_schema_core_96d7e328,node_agent_mmd_orchestration_layer_orchestration_poli_3270b55d,node_agent_mmd_tool_layer_toollayer_policy_validators_af136abf,node_agent_mmd_memory_vector_layer_memorylayer_policy_1944de42,node_agent_mmd_orchestration_layer_orchestration_type_7cf81261,node_agent_mmd_tool_layer_toollayer_types_core_types__6c8319b6,node_agent_mmd_memory_vector_layer_memorylayer_types__83f369fa,node_agent_mmd_orchestration_layer_orchestration_vali_d9fe99e6,node_agent_mmd_tool_layer_toollayer_validator_core_va_6ef6131f,node_agent_mmd_memory_vector_layer_memorylayer_valida_41034356,harness_decision_types_6e63df74,harness_decision_validation_3c4db687,archive_candidates_scanner_d0931789,archive_candidates_dc0e40e1,docs_task_eval_contract_79347457,docs_task_eval_fixtures_44902755,node_agent_mmd_orchestration_layer_orchestration_init_2a9c3ecb,node_agent_mmd_memory_vector_layer_memorylayer_init_m_333d02c5,node_agent_mmd_orchestration_layer_orchestration_proj_6ab6f60f,node_agent_mmd_memory_vector_layer_memorylayer_projec_3ae304d9,scaffold_diagram_templates_dd88e83c,node_agent_mmd_orchestration_layer_orchestration_scaf_12cc07db,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_5fd73b94,node_agent_mmd_orchestration_layer_orchestration_scaf_c9a90c2f,node_agent_mmd_tool_layer_toollayer_scaffold_environm_c1afc013,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_12b42341,node_agent_mmd_orchestration_layer_orchestration_scaf_85b96e78,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_2cb917f1,scaffold_hook_templates_8c74ab50,scaffold_root_command_templates_404fed7f,scaffold_script_template_registry_69312d4e,scaffold_shell_templates_0ad0f915,scaffold_surfaces_12d6494e,node_agent_mmd_orchestration_layer_orchestration_scaf_ff8f92f6,node_agent_mmd_memory_vector_layer_memorylayer_scaffo_a86eece1,scaffold_workflow_template_92310587,eval_seed_5699fd3e,index_10_f6785a46,review_context_1_e3afed15,review_learning_closeout_b7fa3b8e,memory_gate_1_265164ac,branch_enforcer_acb749cd,cli_args_5_09ea29f0,node_agent_mmd_tool_layer_toollayer_cli_cli_2_1_32d9eeaf,node_agent_mmd_memory_vector_layer_memorylayer_cli_cl_1f1f89ab,node_agent_mmd_tool_layer_toollayer_metrics_tracker_m_4c9237d8,node_agent_mmd_memory_vector_layer_memorylayer_metric_12562178,types_20_071a0112,validator_5_b19ac2be,node_agent_mmd_orchestration_layer_orchestration_clas_899b821a,node_agent_mmd_memory_vector_layer_memorylayer_classi_1ebbf5ff,node_agent_mmd_orchestration_layer_orchestration_coll_3a4e3b15,node_agent_mmd_memory_vector_layer_memorylayer_collec_68f0d902,node_agent_mmd_orchestration_layer_orchestration_cont_1f93de91,node_agent_mmd_orchestration_layer_orchestration_tool_6fb851c8,node_agent_mmd_tool_layer_toollayer_tooling_paths_too_64483840,node_agent_mmd_memory_vector_layer_memorylayer_toolin_0b766498,claim_helpers_20dc8387,types_26_a5814179,local_memory_smoke_1175abfc,local_memory_0db17ecc,performance_overload_c685bfcf,node_agent_mmd_orchestration_layer_orchestration_sugg_85c5ebe3,node_agent_mmd_memory_vector_layer_memorylayer_sugges_267f408d,node_agent_mmd_llm_model_layer_llmlayer_git_head_git__09437a5a,node_agent_mmd_memory_vector_layer_memorylayer_git_he_543cbbc5,node_agent_mmd_orchestration_layer_orchestration_prom_e7fa0708,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_0bf03c2e,node_agent_mmd_memory_vector_layer_memorylayer_prompt_b3bc9b07,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_9683b128,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_801c86ff,node_agent_mmd_memory_vector_layer_memorylayer_prompt_84937d91,node_agent_mmd_orchestration_layer_orchestration_prom_77088997,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_e5066b88,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_bd82da46,node_agent_mmd_memory_vector_layer_memorylayer_prompt_efd77624,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_304b3105,node_agent_mmd_memory_vector_layer_memorylayer_prompt_09c6738a,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_18f9b062,node_agent_mmd_tool_layer_toollayer_prompt_context_dr_0bf3d279,node_agent_mmd_memory_vector_layer_memorylayer_prompt_e146d228,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_b57d135a,node_agent_mmd_memory_vector_layer_memorylayer_prompt_0340e365,node_agent_mmd_llm_model_layer_llmlayer_prompt_contex_6426acc2,node_agent_mmd_memory_vector_layer_memorylayer_prompt_55c0d605,types_33_16e22a82,policy_1_fc4198db,node_agent_mmd_tool_layer_toollayer_runtime_card_code_3636ceac,node_agent_mmd_memory_vector_layer_memorylayer_runtim_a5d23e7f,cli_13_ae2ba749,collector_1_bc604d2a,types_36_674380ec,context_contract_aaa6fb53,context_failure_mapping_3d71c384,context_failures_7633ffe2,context_observations_3c057ab7,context_plane_eb195522,context_privacy_d82295ee,context_projection_e9599558,context_provider_51137c0d,context_resolution_input_93eb068b,context_task_1d1d0361,node_agent_mmd_orchestration_layer_orchestration_pack_b4abdaaf,node_agent_mmd_memory_vector_layer_memorylayer_packet_8cb745e6,state_validation_8c9cb007,state_4ba69735,overload_guard_2748c559 memNode
...
flowchart TD
  ...
  cli_13_ae2ba749["cli"]
  Boundary --> cli_13_ae2ba749
  collector_1_bc604d2a["collector"]
  Boundary --> collector_1_bc604d2a
  types_36_674380ec["types"]
  Boundary --> types_36_674380ec
  session_closeout_f3efb270["session-closeout"]
  Boundary --> session_closeout_f3efb270
  packet_candidate_identity_170576d1["packet-candidate-identity"]
  Boundary --> packet_candidate_identity_170576d1
  overload_guard_2748c559["overload-guard"]
  ...
  cli_13_ae2ba749 --> ext_node_fs_df6b52af
  collector_1_bc604d2a --> ext_node_child_process_cb73900b
  collector_1_bc604d2a --> ext_node_fs_df6b52af
  collector_1_bc604d2a --> ext_node_path_0e7d56ab
  packet_candidate_identity_170576d1 --> ext_node_child_process_cb73900b
  packet_candidate_identity_170576d1 --> ext_node_crypto_879f6cbe
  packet_candidate_identity_170576d1 --> ext_node_fs_df6b52af
  overload_guard_2748c559 --> ext_node_os_e9717731
  classDef authNode fill:#7c3aed,color:#fff
  class session_context_e5ec72c0,session_context_command_spec_973afbb1,scaffold_security_scan_template_55bc7465,repository_identity_9dc13d37,cli_13_ae2ba749,collector_1_bc604d2a,types_36_674380ec,session_closeout_f3efb270,packet_candidate_identity_170576d1,overload_guard_2748c559 authNode
...
flowchart TD
  ...
  runtime_packet_schema_test_helpers_893d3bed["runtime-packet-schema-test-helpers"]
  UserRequest --> runtime_packet_schema_test_helpers_893d3bed
  runtime_packet_schema_test_helpers_893d3bed --> runtime_packet_schema_test_helpers_893d3bed_result["result"]
  repo_evidence_38bb1de5["repo-evidence"]
  ...
  execution_job_schema_f68c4ffd["execution-job-schema"]
  UserRequest --> execution_job_schema_f68c4ffd
  execution_job_schema_f68c4ffd --> execution_job_schema_f68c4ffd_result["result"]
  ...
  class fleet_plan_repo_ecdc6499,runtime_packet_schema_test_helpers_893d3bed,repo_evidence_38bb1de5,repo_bound_paths_e218b5b3,json_schema_core_96d7e328,json_schema_74a768d7,execution_job_schema_f68c4ffd,repo_scanner_core_8e9f7646,repo_scanner_a8b2579e,migration_8a6cead4,schema_migrate_c0646635,query_cli_b95be64d,query_presenter_02e6077c,repository_identity_9dc13d37,repo_runtime_artifact_139c0fbd dbNode
...
graph LR
  ...
  node_advisory_artifact_normalizer_5878e309_10de7279["advisory_artifact_normalizer_5878e309"]
  node_agent_native_packet_command_specs_5e921752_9038a743["agent_native_packet_command_specs_5e921752"]
  ...
  node_audit_pnpm_lock_policy_25297ce6_9e69e8a1["audit_pnpm_lock_policy_25297ce6"]
  ...
  node_builtin_command_specs_ac7d392e_b8fd99a0["builtin_command_specs_ac7d392e"]
  node_canary_audit_boundaries_771c27d2_a52bfb1c["canary_audit_boundaries_771c27d2"]
  ...
  node_cli_14_e216587a_decf6c26["cli_14_e216587a"]
  node_cli_5_9c446a0f_12d0ff9c["cli_5_9c446a0f"]
  node_cli_6_eac72be2_9d284979["cli_6_eac72be2"]
  node_cli_9_b54c1407_02daed87["cli_9_b54c1407"]
  ...
  node_collector_1_bc604d2a_f2c72e01["collector_1_bc604d2a"]
  ...
  node_context_1_2c2d8aa6_667214ef["context_1_2c2d8aa6"]
  ...
  node_execution_job_1_ef5ea541_60e804ef["execution_job_1_ef5ea541"]
  node_execution_job_f0dd06de_6f37cbc3["execution_job_f0dd06de"]
  node_execution_result_8d0d5c08_6c1d5184["execution_result_8d0d5c08"]
  node_execution_run_options_2e517b5a_ef586c11["execution_run_options_2e517b5a"]
  ...
  node_git_head_7346fd6a_bca07e9a["git_head_7346fd6a"]
  ...
  node_job_conductor_b96a6aaf_0be266e5["job_conductor_b96a6aaf"]
  node_job_store_4ca3b42f_9d9e6758["job_store_4ca3b42f"]
  ...
  node_local_coordinator_8833f242_09b0484f["local_coordinator_8833f242"]
  ...
  node_next_cli_evidence_2385bd04_53d24990["next_cli_evidence_2385bd04"]
  node_next_pr_closeout_2cf386a5_fcc4fd90["next_pr_closeout_2cf386a5"]
  ...
  node_optional_artifact_normalizers_7bdcc769_2a4d79dc["optional_artifact_normalizers_7bdcc769"]
  ...
  node_packet_caller_candidate_content_2851389c_d14a04d3["packet_caller_candidate_content_2851389c"]
  node_packet_candidate_identity_170576d1_ccac2bae["packet_candidate_identity_170576d1"]
  node_packet_consolidation_baseline_4008303d_d9ecaf1c["packet_consolidation_baseline_4008303d"]
  node_packet_retirement_11dfede5_a558d14f["packet_retirement_11dfede5"]
  node_packet_transition_projection_642dfe3c_05c13491["packet_transition_projection_642dfe3c"]
  ...
  node_process_executor_8cf100a9_ae4a77a9["process_executor_8cf100a9"]
  node_prompt_context_drift_builder_a451c7dd_702c1ffe["prompt_context_drift_builder_a451c7dd"]
  node_prompt_context_drift_validate_runner_c8ecc6f5_48948688["prompt_context_drift_validate_runner_c8ecc6f5"]
  node_prompt_context_drift_validation_8fc01719_589d710a["prompt_context_drift_validation_8fc01719"]
  node_prompt_context_drift_validation_evidence_21f0336_17de7748["prompt_context_drift_validation_evidence_21f0336f"]
  node_prompt_context_drift_write_runner_69e6a4fd_5b8d8b6e["prompt_context_drift_write_runner_69e6a4fd"]
  ...
  node_report_845e9183_9b67bd33["report_845e9183"]
  ...
  node_run_harness_canary_audit_c1ed705c_228e0cad["run_harness_canary_audit_c1ed705c"]
  ...
  node_runtime_packet_schema_test_helpers_893d3bed_e997f09c["runtime_packet_schema_test_helpers_893d3bed"]
  ...
  node_scaffold_gitbook_templates_76afd03a_03d8c6c3["scaffold_gitbook_templates_76afd03a"]
  ...
  node_validate_harness_decision_semantics_3d63690b_ea3399a7["validate_harness_decision_semantics_3d63690b"]
  ...
  node_validate_synaipse_improvement_case_3e2f1aa7_37390c42["validate_synaipse_improvement_case_3e2f1aa7"]
  node_validate_synaipse_transition_0ba0a4bb_265e0ab5["validate_synaipse_transition_0ba0a4bb"]
  ...
  node_write_agent_native_ratchet_report_67cdbeea_83aafb71["write_agent_native_ratchet_report_67cdbeea"]
  node_write_fitness_gate_artifact_c84c6d3c_ca7bd6f7["write_fitness_gate_artifact_c84c6d3c"]
  node_write_prompt_context_drift_report_71a4e149_cf46c973["write_prompt_context_drift_report_71a4e149"]
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_agent_native_packet_command_specs_5e921752_9038a743
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_builtin_command_specs_ac7d392e_b8fd99a0
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_check_public_api_docs_a9604f1b_f824853c
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_collector_1_bc604d2a_f2c72e01
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_git_head_7346fd6a_bca07e9a
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_job_conductor_b96a6aaf_0be266e5
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_packet_caller_candidate_content_2851389c_d14a04d3
  ext_node_child_process_f62b7d19["node:child_process"] --> node_packet_candidate_identity_170576d1_ccac2bae
  ext_node_child_process_f62b7d19["node:child_process"] --> node_packet_retirement_11dfede5_a558d14f
  ext_node_child_process_f62b7d19["node:child_process"] --> node_packet_transition_projection_642dfe3c_05c13491
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_process_executor_8cf100a9_ae4a77a9
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_run_harness_canary_audit_c1ed705c_228e0cad
  ...
  ext_node_child_process_f62b7d19["node:child_process"] --> node_validate_synaipse_improvement_case_3e2f1aa7_37390c42
  ext_node_child_process_f62b7d19["node:child_process"] --> node_validate_synaipse_transition_0ba0a4bb_265e0ab5
  ext_node_child_process_f62b7d19["node:child_process"] --> node_version_coherence_69733bcb_00c8d5d9
  ext_node_child_process_f62b7d19["node:child_process"] --> node_write_agent_native_ratchet_report_67cdbeea_83aafb71
  ext_node_child_process_f62b7d19["node:child_process"] --> node_write_fitness_gate_artifact_c84c6d3c_ca7bd6f7
  ext_node_child_process_f62b7d19["node:child_process"] --> node_write_prompt_context_drift_report_71a4e149_cf46c973
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_audit_pnpm_lock_3bdddae2_660ed5e1
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_check_code_quality_debt_cba04f67_104c73f4
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_execution_job_1_ef5ea541_60e804ef
  ext_node_crypto_c7dfc512["node:crypto"] --> node_execution_result_8d0d5c08_6c1d5184
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_job_conductor_b96a6aaf_0be266e5
  ext_node_crypto_c7dfc512["node:crypto"] --> node_job_store_4ca3b42f_9d9e6758
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_local_coordinator_8833f242_09b0484f
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_packet_candidate_identity_170576d1_ccac2bae
  ext_node_crypto_c7dfc512["node:crypto"] --> node_packet_consolidation_baseline_4008303d_d9ecaf1c
  ext_node_crypto_c7dfc512["node:crypto"] --> node_packet_retirement_11dfede5_a558d14f
  ...
  ext_node_crypto_c7dfc512["node:crypto"] --> node_prompt_context_drift_builder_a451c7dd_702c1ffe
  ext_node_crypto_c7dfc512["node:crypto"] --> node_prompt_context_drift_validation_evidence_21f0336_17de7748
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_advisory_artifact_normalizer_5878e309_10de7279
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_cli_14_e216587a_decf6c26
  ext_node_fs_a15b7d96["node:fs"] --> node_cli_6_eac72be2_9d284979
  ext_node_fs_a15b7d96["node:fs"] --> node_cli_9_b54c1407_02daed87
  ext_node_fs_a15b7d96["node:fs"] --> node_cli_99bb8840_659774ba
  ext_node_fs_a15b7d96["node:fs"] --> node_collector_0736fd5b_10bc1882
  ext_node_fs_a15b7d96["node:fs"] --> node_collector_1_bc604d2a_f2c72e01
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_context_1_2c2d8aa6_667214ef
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_execution_job_f0dd06de_6f37cbc3
  ext_node_fs_a15b7d96["node:fs"] --> node_execution_run_options_2e517b5a_ef586c11
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_job_store_4ca3b42f_9d9e6758
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_local_coordinator_8833f242_09b0484f
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_optional_artifact_normalizers_7bdcc769_2a4d79dc
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_packet_caller_candidate_content_2851389c_d14a04d3
  ext_node_fs_a15b7d96["node:fs"] --> node_packet_candidate_identity_170576d1_ccac2bae
  ext_node_fs_a15b7d96["node:fs"] --> node_packet_consolidation_baseline_4008303d_d9ecaf1c
  ext_node_fs_a15b7d96["node:fs"] --> node_packet_retirement_11dfede5_a558d14f
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_prompt_context_drift_validation_evidence_21f0336_17de7748
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_report_845e9183_9b67bd33
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_run_harness_canary_audit_c1ed705c_228e0cad
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_runtime_packet_schema_test_helpers_893d3bed_e997f09c
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_scaffold_gitbook_templates_76afd03a_03d8c6c3
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_validate_harness_decision_semantics_3d63690b_ea3399a7
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_validate_synaipse_improvement_case_3e2f1aa7_37390c42
  ext_node_fs_a15b7d96["node:fs"] --> node_validate_synaipse_transition_0ba0a4bb_265e0ab5
  ...
  ext_node_fs_a15b7d96["node:fs"] --> node_write_agent_native_ratchet_report_67cdbeea_83aafb71
  ext_node_fs_a15b7d96["node:fs"] --> node_write_fitness_gate_artifact_c84c6d3c_ca7bd6f7
  ext_node_fs_a15b7d96["node:fs"] --> node_write_prompt_context_drift_report_71a4e149_cf46c973
  ...
  ext_node_os_d93fe73a["node:os"] --> node_run_harness_canary_audit_c1ed705c_228e0cad
  ...
  ext_node_path_78811c13["node:path"] --> node_agent_native_packet_command_specs_5e921752_9038a743
  ...
  ext_node_path_78811c13["node:path"] --> node_artifact_normalizers_cc0daa9f_95587db6
  ...
  ext_node_path_78811c13["node:path"] --> node_canary_audit_boundaries_771c27d2_a52bfb1c
  ...
  ext_node_path_78811c13["node:path"] --> node_cli_14_e216587a_decf6c26
  ...
  ext_node_path_78811c13["node:path"] --> node_collector_1_bc604d2a_f2c72e01
  ...
  ext_node_path_78811c13["node:path"] --> node_context_1_2c2d8aa6_667214ef
  ...
  ext_node_path_78811c13["node:path"] --> node_execution_job_f0dd06de_6f37cbc3
  ext_node_path_78811c13["node:path"] --> node_execution_run_options_2e517b5a_ef586c11
  ...
  ext_node_path_78811c13["node:path"] --> node_job_store_4ca3b42f_9d9e6758
  ...
  ext_node_path_78811c13["node:path"] --> node_local_coordinator_8833f242_09b0484f
  ...
  ext_node_path_78811c13["node:path"] --> node_packet_consolidation_baseline_4008303d_d9ecaf1c
  ext_node_path_78811c13["node:path"] --> node_packet_retirement_11dfede5_a558d14f
  ...
  ext_node_path_78811c13["node:path"] --> node_prompt_context_drift_builder_a451c7dd_702c1ffe
  ext_node_path_78811c13["node:path"] --> node_prompt_context_drift_validation_8fc01719_589d710a
  ext_node_path_78811c13["node:path"] --> node_prompt_context_drift_validation_evidence_21f0336_17de7748
  ...
  ext_node_path_78811c13["node:path"] --> node_run_harness_canary_audit_c1ed705c_228e0cad
  ...
  ext_node_path_78811c13["node:path"] --> node_runtime_packet_schema_test_helpers_893d3bed_e997f09c
  ...
  ext_node_path_78811c13["node:path"] --> node_validate_synaipse_improvement_case_3e2f1aa7_37390c42
  ext_node_path_78811c13["node:path"] --> node_validate_synaipse_transition_0ba0a4bb_265e0ab5
  ...
  ext_node_path_78811c13["node:path"] --> node_write_agent_native_ratchet_report_67cdbeea_83aafb71
  ...
  ext_node_process_00cdf119["node:process"] --> node_audit_pnpm_lock_policy_25297ce6_9e69e8a1
  ...
  ext_node_process_00cdf119["node:process"] --> node_next_cli_evidence_2385bd04_53d24990
  ...
  ext_node_url_d0cb3ad7["node:url"] --> node_prompt_context_drift_builder_a451c7dd_702c1ffe
  ...
  ext_node_url_d0cb3ad7["node:url"] --> node_run_harness_canary_audit_c1ed705c_228e0cad
  ...
  ext_node_url_d0cb3ad7["node:url"] --> node_validate_synaipse_improvement_case_3e2f1aa7_37390c42
  ...
  ext_typescript_fb9da861["typescript"] --> node_check_code_quality_debt_cba04f67_104c73f4
  ...
  ext_yaml_c94c088e["yaml"] --> node_audit_pnpm_lock_policy_25297ce6_9e69e8a1
  ...
  style ext_node_util_f2cdb29c fill:#f59e0b,color:#fff
...
flowchart LR
  ...
  subgraph DetectedMemory["Detected memory stores"]
    det_detectedmemory_check_gitbook_readiness_33bdca76[("check-gitbook-readiness")]
    det_detectedmemory_check_steering_feedback_contract_80134459[("check-steering-feedback-contract")]
    det_detectedmemory_prompt_context_drift_validate_runner_c8ecc6f5[("prompt-context-drift-validate-runner")]
    det_detectedmemory_prompt_context_drift_write_runner_69e6a4fd[("prompt-context-drift-write-runner")]
    det_detectedmemory_normalize_workflow_contracts_8701f1c8[("normalize-workflow-contracts")]
    det_detectedmemory_run_harness_evals_77704768[("run-harness-evals")]
    ...
    det_detectedmemory_validate_harness_decision_semantics_3d63690b[("validate-harness-decision-semantics")]
    ...
    det_detectedmemory_write_agent_native_ratchet_report_67cdbeea[("write-agent-native-ratchet-report")]
    det_detectedmemory_write_prompt_context_drift_report_71a4e149[("write-prompt-context-drift-report")]
    ...
    det_detectedmemory_next_orientation_meta_3a6af72b[("next-orientation-meta")]
    det_detectedmemory_next_prompt_context_drift_3c5a93d5[("next-prompt-context-drift")]
    det_detectedmemory_next_recommendation_decisions_03315dd4[("next-recommendation-decisions")]
    det_detectedmemory_next_runner_state_be6fe997[("next-runner-state")]
    det_detectedmemory_next_runner_41643472[("next-runner")]
    det_detectedmemory_next_synaipse_context_8436b36b[("next-synaipse-context")]
    ...
    det_detectedmemory_prompt_context_drift_surface_c1e30b42[("prompt-context-drift-surface")]
    det_detectedmemory_test_fixtures_c2f936b0[("test-fixtures")]
    det_detectedmemory_types_2_d9bc6e7a[("types")]
    det_detectedmemory_branch_protect_sync_570adb18[("branch-protect-sync")]
    det_detectedmemory_builtin_command_specs_ac7d392e[("builtin-command-specs")]
    det_detectedmemory_command_capability_rules_ca3f496a[("command-capability-rules")]
    det_detectedmemory_command_expected_artifacts_6469c2fb[("command-expected-artifacts")]
    det_detectedmemory_command_invocation_effects_fbc96da5[("command-invocation-effects")]
    det_detectedmemory_command_specs_core_1c0ffc99[("command-specs-core")]
    det_detectedmemory_command_visibility_rules_83c6a86a[("command-visibility-rules")]
    ...
    det_detectedmemory_harness_decision_types_6e63df74[("harness-decision-types")]
    det_detectedmemory_harness_decision_validation_3c4db687[("harness-decision-validation")]
    ...
    det_detectedmemory_scaffold_gitbook_templates_76afd03a[("scaffold-gitbook-templates")]
    ...
    det_detectedmemory_review_learning_closeout_b7fa3b8e[("review-learning-closeout")]
    ...
    det_detectedmemory_types_20_071a0112[("types")]
    ...
    det_detectedmemory_context_1_2c2d8aa6[("context")]
    det_detectedmemory_types_22_f3cf4a73[("types")]
    det_detectedmemory_tooling_paths_560ac80d[("tooling-paths")]
    det_detectedmemory_claim_helpers_20dc8387[("claim-helpers")]
    det_detectedmemory_types_26_a5814179[("types")]
    ...
    det_detectedmemory_git_head_7346fd6a[("git-head")]
    det_detectedmemory_index_12_762ec91b[("index")]
    det_detectedmemory_prompt_context_drift_builder_a451c7dd[("prompt-context-drift-builder")]
    ...
    det_detectedmemory_prompt_context_drift_validation_evidence_21f0336f[("prompt-context-drift-validation-evidence")]
    det_detectedmemory_prompt_context_drift_validation_utils_2285f4ac[("prompt-context-drift-validation-utils")]
    det_detectedmemory_prompt_context_drift_validation_8fc01719[("prompt-context-drift-validation")]
    ...
    det_detectedmemory_cli_13_ae2ba749[("cli")]
    det_detectedmemory_collector_1_bc604d2a[("collector")]
    det_detectedmemory_types_36_674380ec[("types")]
    det_detectedmemory_context_contract_aaa6fb53[("context-contract")]
    det_detectedmemory_context_failure_mapping_3d71c384[("context-failure-mapping")]
    det_detectedmemory_context_failures_7633ffe2[("context-failures")]
    det_detectedmemory_context_observations_3c057ab7[("context-observations")]
    det_detectedmemory_context_plane_eb195522[("context-plane")]
    det_detectedmemory_context_privacy_d82295ee[("context-privacy")]
    det_detectedmemory_context_projection_e9599558[("context-projection")]
    det_detectedmemory_context_provider_51137c0d[("context-provider")]
    det_detectedmemory_context_resolution_input_93eb068b[("context-resolution-input")]
    det_detectedmemory_context_task_1d1d0361[("context-task")]
    det_detectedmemory_packet_consolidation_contract_293284fb[("packet-consolidation-contract")]
    det_detectedmemory_state_validation_8c9cb007[("state-validation")]
    det_detectedmemory_state_4ba69735[("state")]
  ...
  subgraph DetectedLLM["Detected LLM clients"]
    ...
    det_detectedllm_prompt_context_drift_validate_runner_c8ecc6f5["prompt-context-drift-validate-runner"]
    det_detectedllm_prompt_context_drift_write_runner_69e6a4fd["prompt-context-drift-write-runner"]
    ...
    det_detectedllm_write_prompt_context_drift_report_71a4e149["write-prompt-context-drift-report"]
    ...
    det_detectedllm_next_prompt_context_drift_3c5a93d5["next-prompt-context-drift"]
    det_detectedllm_next_recommendation_decisions_03315dd4["next-recommendation-decisions"]
    ...
    det_detectedllm_prompt_context_drift_surface_c1e30b42["prompt-context-drift-surface"]
    det_detectedllm_test_fixtures_c2f936b0["test-fixtures"]
    det_detectedllm_builtin_command_specs_ac7d392e["builtin-command-specs"]
    det_detectedllm_command_expected_artifacts_6469c2fb["command-expected-artifacts"]
    det_detectedllm_command_specs_core_1c0ffc99["command-specs-core"]
    det_detectedllm_pilot_evaluate_command_spec_1084ea72["pilot-evaluate-command-spec"]
    det_detectedllm_pilot_rollback_command_spec_4fe69f7d["pilot-rollback-command-spec"]
    ...
    det_detectedllm_types_18_37582e2a["types"]
    ...
    det_detectedllm_git_head_7346fd6a["git-head"]
    det_detectedllm_index_12_762ec91b["index"]
    det_detectedllm_prompt_context_drift_builder_a451c7dd["prompt-context-drift-builder"]
    ...
    det_detectedllm_prompt_context_drift_validation_evidence_21f0336f["prompt-context-drift-validation-evidence"]
    det_detectedllm_prompt_context_drift_validation_utils_2285f4ac["prompt-context-drift-validation-utils"]
    det_detectedllm_prompt_context_drift_validation_8fc01719["prompt-context-drift-validation"]
    ...
    det_detectedllm_cli_12_01c06c37["cli"]
    det_detectedllm_sections_4697ef32["sections"]
    det_detectedllm_types_29_929d5a70["types"]
  ...
  subgraph DetectedTools["Agentic tool calls"]
    ...
    det_detectedtools_next_pr_closeout_contract_af31d30a["🔧 next-pr-closeout-contract"]
    ...
    det_detectedtools_command_agent_native_capability_rules_b491ef6c["🔧 command-agent-native-capability-rules"]
    ...
    det_detectedtools_command_visibility_rules_83c6a86a["🔧 command-visibility-rules"]
    ...
    det_detectedtools_tooling_paths_560ac80d["🔧 tooling-paths"]
    ...
    det_detectedtools_prompt_context_drift_validation_utils_2285f4ac["🔧 prompt-context-drift-validation-utils"]
    ...
    det_detectedtools_transition_contract_0732d034["🔧 transition-contract"]
    det_detectedtools_transition_recovery_validation_e06db55b["🔧 transition-recovery-validation"]
    det_detectedtools_transition_70dd37c1["🔧 transition"]
    det_detectedtools_index_17_642943a2["🔧 index"]
    det_detectedtools_projection_1b250ea1["🔧 projection"]
    det_detectedtools_types_40_c7e41f89["🔧 types"]
    det_detectedtools_validation_8_b9fa10af["🔧 validation"]
  end
...
flowchart TD
  ...
  audit_pnpm_lock_policy_25297ce6["audit-pnpm-lock-policy"]
  Untrusted --> audit_pnpm_lock_policy_25297ce6
  canary_audit_boundaries_771c27d2["canary-audit-boundaries"]
  Untrusted --> canary_audit_boundaries_771c27d2
  direct_pnpm_audit_9a9a9ed4["direct-pnpm-audit"]
  Untrusted --> direct_pnpm_audit_9a9a9ed4
  run_harness_canary_audit_c1ed705c["run-harness-canary-audit"]
  Untrusted --> run_harness_canary_audit_c1ed705c
