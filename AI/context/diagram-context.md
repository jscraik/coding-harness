...
Generated: 2026-06-14T01:36:32Z
...
- `src/lib/agent-readiness/shared-state-policy.ts`
...
- `src/lib/contract/shared-state-action-validator.ts`
...
- `src/lib/preflight/file-tail.ts`
- `src/lib/preflight/local-memory.ts`
