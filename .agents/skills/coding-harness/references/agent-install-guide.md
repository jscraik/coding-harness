...
| `.coderabbit.yaml` | `harness init` \u2014 CodeRabbit review baseline |
| `scripts/check-semgrep-changed.sh` | `harness init` \u2014 changed-file Semgrep lane |
| `scripts/check-semgrep-full.sh` | `harness init` \u2014 full-repository Semgrep lane |
| `scripts/semgrep-bootstrap.sh` | `harness init` \u2014 pinned Semgrep runtime bootstrap |
| `scripts/semgrep-pre-push.yml` | `harness init` \u2014 local Semgrep ruleset |
