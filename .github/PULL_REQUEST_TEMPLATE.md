...
- [ ] Required local gates run: `bash scripts/validate-codestyle.sh`, `pnpm check`, `harness tooling-audit --path . --json`.
...
- Command: `harness tooling-audit --path . --json` -> pass/fail
