...
harness next --json --synaipse-transition artifacts/synaipse-transition.json
...
| `next`              | Read-only agent cockpit entrypoint that recommends the next safe existing command (`--json`, optional `--files`, optional `--phase-exit`, optional `--runtime-card`, optional `--pr-closeout`, optional `--fitness-report`, optional `--synaipse-transition`, optional `--mode local\|pr\|ci`)                                                                                                                               |
