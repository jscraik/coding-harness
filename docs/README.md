...
- [Extending This Index](#extending-this-index)

## Start Here
- [Root README](../README.md)
- [Root AGENTS](../AGENTS.md)
- [Instruction map](./agents/01-instruction-map.md)
...
- [Security and governance](./agents/06-security-and-governance.md)

## Validation and Quality
- [Validation](./agents/04-validation.md)
- [Agent testing gates](./agents/10-agent-testing-gates.md)
...
- Add a new bucket only when a docs family has more than one stable file.
- Keep leaf detail in the target doc, not in this index.
- Prefer linking to canonical family hubs instead of enumerating every file.
