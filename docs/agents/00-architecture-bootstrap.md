...
For release packaging changes that alter runtime dependency metadata, run the packed CLI smoke path before publish and commit any required `AI/context/diagram-context.md` refresh that pre-push reports.
