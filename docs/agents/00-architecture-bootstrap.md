...
For root-surface cleanup, use `docs/architecture/root-surface-classification.md` as the tracked classification contract. Move historical root evidence into `docs/archive/root-cleanup/` or a domain docs surface before considering deletion, and keep `AGENTS.md`, this guide, `docs/README.md`, and `docs/agents/07b-agent-governance.md` synchronized when docs-gate reports architecture-context or agent-governance surfaces.
