...
For validation gate graph changes, refresh `AI/context/diagram-context.md` and this guide together when new typed gate specs, parity tests, or resume-checkpoint guards change the architecture context pack.
