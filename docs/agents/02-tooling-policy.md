...
| Code-style gate | `bash scripts/validate-code-style.sh` | Fail-closed repo-local code-style validation |
...
3. Run `bash scripts/validate-code-style.sh --fast`.
4. Run `bash scripts/validate-code-style.sh` before handoff.
