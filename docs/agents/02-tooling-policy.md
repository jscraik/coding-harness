...
`pnpm docs:archive-candidates -- --json` is part of the documentation tooling surface. It reports stale-document candidates and repair hints as advisory evidence only; any archive, move, delete, demotion, or metadata rewrite requires a separate reviewed decision.
