...
- `tool`: setup and utility actions such as `Tools` (compatibility-required), `Tooling` (expanded diagnostics), `Diagram`, `Mise`, `Agent Browser`, `Agentation`, `Context7`, `1Password`, `Beautiful Mermaid`, `Auth0`, `Semver`, `Research`, and `WSearch`
