...
If either condition is not met, the step is skipped silently. If `mise trust` fails, a warning is printed but worktree preparation continues with the existing trust state.
