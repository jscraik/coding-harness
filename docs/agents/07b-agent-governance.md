...
- release packaging changes that alter runtime dependency metadata should keep packed CLI smoke evidence, `AGENTS.md`, `docs/agents/00-architecture-bootstrap.md`, and this guide synchronized when docs-gate or pre-push refreshes architecture context
