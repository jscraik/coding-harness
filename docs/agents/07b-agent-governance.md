...
- If a reproducible coding-harness bug, policy gap, workflow regression, or automation issue is found: create or update a Linear issue with repro + evidence before handoff.
